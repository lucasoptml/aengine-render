...
//DX11
//NOTE: removed shared from numeric values
//		added all globals to shared cbuffer Globals
//NOTE: recommended that you use Map and Discard for these.
//NOTE: WorldMx is likely to change a lot, should be separate and not shared.
//shared cbuffer Globals
//{
//	float TimeSeconds;
